            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item">
                            <a href="chercher" class="sidebar-link">Chercher un Tifo</a>
                        </li>
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="contact-menu" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="index.php" class="sidebar-link">Contacter Leader</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="emailM.php" class="sidebar-link">Contacter Membre</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
